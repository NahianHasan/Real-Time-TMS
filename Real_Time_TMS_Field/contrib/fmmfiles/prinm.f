...
1001  FORMAT(/)
      DO 100 L = 0,NTERMS
C         WRITE(6,1000)(MPOLE(L,M),M=-L,L)
C         WRITE(13,1000)(MPOLE(L,M),M=-L,L)
C         WRITE(6,1001)
C         WRITE(13,1001)
100   CONTINUE
        return
...
C
      ...
      DO 200 L = 0,NTERMS
C         WRITE(6,1000)(MPOLE0(L,M),M=0,L)
C         WRITE(13,1000)(MPOLE0(L,M),M=0,L)
C         WRITE(6,1001)
C         WRITE(13,1001)
200   CONTINUE
c
...
c
      ...
      DO 400 L = 0,NTERMS-1
C         WRITE(6,1000)MPOLE(L,L), MPOLE(L+1,L)
C         WRITE(13,1000)MPOLE(L,L), MPOLE(L+1,L)
C         WRITE(6,1001)
C         WRITE(13,1001)
400   CONTINUE
c
