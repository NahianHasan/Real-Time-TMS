...
extern "C" void rhsfuncrsjsksrhos   (const int nte,const int np,const  int* te2p,const  double* p,const  double* reg,const int nsource,const double *rs,const  double* js,const  double* ks,const  double* rho,double* rhs,const double iprec);
extern "C" void rhsfunc2ndrsjsksrhos(const int nte,const int np,const  int* te2p,const  double* p,const  double* reg,const int nsource,const double *rs,const  double* js,const  double* ks,const  double* rho,double* rhs,const double iprec);
extern "C" void rhsfunc3rdrsjsksrhos(const int nte,const int np,const  int* te2p,const  double* p,const  double* reg,const int nsource,const double *rs,const  double* js,const  double* ks,const  double* rho,double* rhs,const double iprec);
...
Eprimrsjsksrho(nsource,ntarget,rs,js,ks,rho,robs,Eprimary,iprec);
