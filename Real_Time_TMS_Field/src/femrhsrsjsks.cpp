...
extern "C" void rhsfunc2ndrsjsksrhos(const int nte,const int np,const  int* te2p,const  double* p,const  double* reg,int nsource, double *rs,double* js,double* rhs,double iprec);
extern "C" void rhsfunc3rdrsjsksrhos(const int nte,const int np,const  int* te2p,const  double* p,const  double* reg,int nsource, double *rs,double* js,double* rhs,double iprec);
...
void rhsfunc2ndrsjsksrhos(const int nte,const int np,const  int* te2p,const  double* p,const  double* reg,int nsource,const double* rs,const  double* js,const  double* ks,const double* rho, double* rhs,double iprec) {
  const double mu0=1.25663706e-6;
...
void rhsfunc3rd(const int nte,const int np,const  int* te2p,const  double* p,const  double* reg,int nsource,const double* rs,const  double* js,const  double* ks,const double* rho, double* rhs,double iprec) {
  const double mu0=1.25663706e-6;
  //all this just makes sorted triangles with lists of tetra pointers
