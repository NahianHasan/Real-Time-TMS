...
iprec=10^-4;
if FEMord==1
mex_id_ = 'rhsfunc(i int, i int, i int[xx], i double[xx], i double[x], i int, i double[xx], i double[xx], io double[x], i double)';
[rhs] = FEM(mex_id_, nte, np, te2p, p, reg, nsource, rs, js, rhs, iprec, 4, nte, 3, np, nte, 3, nsource, 3, nsource, np);
elseif FEMord==2
mex_id_ = 'rhsfunc2nd(i int, i int, i int[xx], i double[xx], i double[x], i int, i double[xx], i double[xx], io double[x], i double)';
[rhs] = FEM(mex_id_, nte, np, te2p, p, reg, nsource, rs, js, rhs, iprec, 10, nte, 3, np, nte, 3, nsource, 3, nsource, np);
elseif FEMord==3
mex_id_ = 'rhsfunc3rd(i int, i int, i int[xx], i double[xx], i double[x], i int, i double[xx], i double[xx], io double[x], i double)';
