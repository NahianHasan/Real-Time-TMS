function [tri,pp,Eaux_expected,Eaux_stddev,Anor,UQkit,roicen]=genrecipmapksUQ(te2p,p,conductivity,teid,that,rs,ks,omega,scth,th_hair,N,FEMord,posuq,anguq)
