...
## LICENSE
Any commercial usage of the software or integration into another software is restricted unless explicit notice is provided to the core contributors/developers/authors and gain explicit confirmation from the contributors/developers/authors. [LICENSE](LICENSE-CC-BY-NC-ND-4.0.md)
...
### Real-Time-Paper
Hasan, N. I., Dannhauer, M., Wang, D., Deng, Z. D., & Gomez, L. J. (2023). Real-Time Computation of Brain E-Field for Enhanced Transcranial Magnetic Stimulation Neuronavigation and Optimization. bioRxiv.
### Probabilistic Matrix Decomposition - Auxiliary Dipole Method (PMD-ADM)
Hasan, N. I., Wang, D., & Gomez, L. J. (2023). Fast and accurate computational E-field dosimetry for group-level transcranial magnetic stimulation targeting. Computers in Biology and Medicine, 167, 107614.
### Adaptive Cross Approximation - Auxiliary Dipole Method (ACA-ADM)
Wang, D., Hasan, N. I., Dannhauer, M., Yucel, A. C., & Gomez, L. J. (2023). Fast computational E-field dosimetry for transcranial magnetic stimulation using adaptive cross approximation and auxiliary dipole method (ACA-ADM). NeuroImage, 267, 119850.
