...
| coil model file | TMS coil model | rcoil = $N_c\times 3$ <br /> jcoil = $N_c\times 3$ <br />, If you have your own coil model file, change the function load_coil_model.m. The initial version of this page supports only electric dipole mmodel of the coil. |
