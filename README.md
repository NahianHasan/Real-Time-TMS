...
## LICENSE
Any commercial usage of the software or integration into another software is restricted unless explicit notice is provided to the core contributors/developers/authors and gain explicit confirmation from the contributors/developers/authors. [LICENSE](LICENSE)
